...
SECRET_KEY = 'django-insecure-n-$-!f#txb)g2ps&lq_z^6^0#-ktzz0$&7)9y#%!p6(4&r$d=b'
...
EMAIL_USE_SSL = True
EMAIL_USE_TLS = False
EMAIL_HOST_USER = 'test01324@yandex.com'
EMAIL_HOST_PASSWORD = 'oqyciacciawpqkqf'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Путь для сборки статических файлов для продакшн
